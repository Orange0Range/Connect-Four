...
class Game{
  ...
  startGame(){
    ...
    this.gameOver = false;
    this.gameBoard = [];
    const p1Color = document.getElementById('p1').value != ""?document.getElementById('p1').value:'blue'
    const p2Color = document.getElementById('p2').value != ""?document.getElementById('p2').value:'red'
